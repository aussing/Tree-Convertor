...
FirstHaloInFOFgroup = tree_data['TreeHalos/TreeFirstHaloInFOFgroup']
NextHaloInFOFgroup = tree_data['TreeHalos/TreeNextHaloInFOFgroup']



##Sub halo Properties

Len = tree_data['TreeHalos/SubhaloLen']
